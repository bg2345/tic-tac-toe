...
export default class App extends React.Component {
  ...
  // Returns 1 if Player 1 wins, -1 if player 2 wins, or 0 if there is no winner
  getWinner = () => {
    const NUM_TILES = 3;
  ...
  onTilePress = (row, col) => {
    // Don't allow tiles to be changed
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Button title="New Game" onPress={this.newGamePress} />
